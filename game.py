...
initialState = {"window": {"width": 900, "height": 900}}
...
class State:
    ...
    def register(self, name, mutator=lambda x, y: x, scope=""):
        """
...
class Game:
    ...
    def __init__(self, state: State, publisher: Publisher):
        ...
        self.state_change_listener = publisher.subscribe(
            "change:state", lambda scope: self.update()
        )
